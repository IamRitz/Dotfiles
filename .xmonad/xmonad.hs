...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_m), spawn $ "spotify" )
  , ((modMask, xK_b), spawn $ "brave" )
  , ((modMask, xK_d), spawn $ "discord" )
  , ((modMask, xK_q), kill )
  , ((modMask, xK_r), spawn $ "alacritty -e ranger" )
  , ((modMask, xK_i), spawn $ "rofi -show calc -modi calc -no-show-match -no-sort" )
  ...
  , ((modMask, xK_F12), spawn $ "rofi -show window" )
  ...
  , ((modMask .|. shiftMask , xK_d ), spawn $ "dmenu_run -i -p \"Run: \" -sb '#8a2be2' -shb '#ffd700' -shf '#342860' -nhf '#8a2be2' -nhb '#133337' -h 30 -fn 'NotoMonoRegular:regular:pixelsize=16'")
  ...
  , ((controlMask .|. mod1Mask , xK_w ), spawn $ "archlinux-welcome-app")
